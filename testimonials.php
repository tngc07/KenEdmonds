  ...
  <body>
    ...
    <section class="hero_articles">
	  ...
	  <?php 
		  ...
		  $liveArticles = mysqli_query($con,"SELECT * FROM blog WHERE wheretopost='testimonials'");
		  $getArticles = mysqli_query($con,"SELECT * FROM blog WHERE wheretopost='testimonials'");

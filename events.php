  ...
  <body>
    ...
    <section class="hero_articles">
	  ...
	  <?php 
		  ...
		  $liveArticles = mysqli_query($con,"SELECT * FROM blog WHERE wheretopost='px_event'");
		  ...
		  echo '<h3 style="background:#e4b7f0; color:#fff; padding-left:20px; padding-top:30px; padding-bottom:30px; border-bottom:#4d2665 solid 5px;">Upcomming Events</h3>';
		   
		   echo '<ul id="listofarticles" class="side-nav">';
		  
		  	$nu = 1;
		    while($a = mysqli_fetch_array($liveArticles)){
			
		  	echo '<li id="art_'.$nu++.'x"> <a class="blogGet" href="">'.$a['blog_title'].'</a></li>';	  
